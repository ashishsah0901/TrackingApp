...
import com.example.tracker.ui.CustomMarkerView
import com.example.tracker.ui.StatisticsViewModel
    ...
    private fun subscribeToObservers(){
        ...
        viewModel.runsSortedByDate.observe(viewLifecycleOwner, {
            it?.let {
                ...
                val marker = CustomMarkerView(it.reversed(), requireContext(), R.layout.marker_view)
